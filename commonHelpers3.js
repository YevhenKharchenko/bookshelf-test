import"./assets/modulepreload-polyfill-3cfb730f.js";/* empty css                             */import"https://cdn.skypack.dev/axios";import{P as l}from"./assets/vendor-64d08f96.js";const c=document.getElementById("tui-pagination-container"),p=new l(c);p.getCurrentPage();const g=document.querySelector(".shopping-list"),e=JSON.parse(localStorage.getItem("booksArray"))||[];function d(){try{if(!e)return;e.forEach(t=>m(t))}catch(t){console.log(t),iziToast.error({title:"Error",message:`Oops! Something went wrong. Please try again later or contact support if the issue persists. Error details: ${t.message}`,position:"topRight"})}}function m(t){const o=`<li class="shopping-list-item" data-id="${t._id}">
