import"./assets/modulepreload-polyfill-3cfb730f.js";/* empty css                             */import{P as p}from"./assets/vendor-64d08f96.js";const n=JSON.parse(localStorage.getItem("books"))||[],g=document.querySelector(".tui-pagination"),s=document.querySelector(".shopping-list"),o=new p(g,{totalItems:n.length,itemsPerPage:3,visiblePages:3,page:1});o.on("afterMove",function(e){c(e.page)});function c(e){s.innerHTML="";const t=(e-1)*o._options.itemsPerPage,i=t+o._options.itemsPerPage;n.slice(t,i).forEach(a=>{l(a)})}function l(e){const t=`
  <li id="${e._id}">
