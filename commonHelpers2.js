import"./assets/modulepreload-polyfill-3cfb730f.js";import{P as p}from"./assets/vendor-fa016dd5.js";const n=JSON.parse(localStorage.getItem("books"))||[],g=document.querySelector(".tui-pagination"),a=document.querySelector(".shopping-list"),o=new p(g,{totalItems:n.length,itemsPerPage:3,visiblePages:3,page:1,centerAlign:!0});o.on("afterMove",function(e){c(e.page)});function c(e){a.innerHTML="";const t=(e-1)*o._options.itemsPerPage,i=t+o._options.itemsPerPage;n.slice(t,i).forEach(s=>{l(s)})}function l(e){const t=`
  <li id="${e._id}">
